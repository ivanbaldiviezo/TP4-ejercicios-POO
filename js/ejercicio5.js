...
class Persona {
    ...
    mostrarGeneracion() {
      ...
      document.write(`<p>${this.nombre} pertenece a la generación ${generacion}.</p>`);
    }
  
    // Método para calcular la generación basada en el año de nacimiento
    calcularGeneracion() {
    ...
    // Método para mostrar todos los datos del objeto
    mostrarDatos() {
      ...
      document.write(`<p>Es mayor de edad: ${this.esMayorDeEdad() ? 'Sí' : 'No'}</p>`);
